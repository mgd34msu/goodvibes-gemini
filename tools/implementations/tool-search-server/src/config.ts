...
export const PLUGIN_ROOT = process.env.PLUGIN_ROOT || process.env.GEMINI_PLUGIN_ROOT || path.resolve(getConfigDir(), '../../..');
export const PROJECT_ROOT = process.env.PROJECT_ROOT || process.env.GEMINI_PROJECT_DIR || process.cwd();
