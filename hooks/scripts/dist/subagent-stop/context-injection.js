 ...
 */
export function buildOrchestratorContext(cwd, agentType, agentId, success) {
    ...
    contextParts.push('ORCHESTRATOR REMINDER: You are the orchestrator. Delegate ALL project work to specialist agents. ' +
    ...
    contextParts.push('GOODVIBES STATE: Use the .goodvibes/ directory for persistence across context compactions:\n' +
    ...
    // MCP tools reminder
    contextParts.push('MCP TOOLS: Use mcp-cli tools for project introspection (detect_stack, check_types, project_issues, etc.) ' +
