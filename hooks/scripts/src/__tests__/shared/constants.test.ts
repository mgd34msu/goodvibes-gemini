...
describe('constants', () => {
  ...
  const originalProjectDir = process.env.GEMINI_PROJECT_DIR;
  ...
  afterEach(() => {
    ...
    if (originalProjectDir === undefined) {
      ...
      process.env.GEMINI_PROJECT_DIR = originalProjectDir;
    }
  ...
  describe('PLUGIN_ROOT', () => {
    it('should use GEMINI_PLUGIN_ROOT env var when set', async () => {
      process.env.GEMINI_PLUGIN_ROOT = '/custom/plugin/root';
      vi.resetModules();
  ...
  describe('PROJECT_ROOT', () => {
    it('should use GEMINI_PROJECT_DIR env var when set', async () => {
      process.env.GEMINI_PROJECT_DIR = '/custom/project/dir';
      vi.resetModules();
  ...
  describe('CACHE_DIR', () => {
    it('should be derived from PLUGIN_ROOT with .cache suffix', async () => {
      process.env.GEMINI_PLUGIN_ROOT = '/test/plugin';
      vi.resetModules();
  ...
  describe('path relationships', () => {
    it('should have consistent path hierarchy', async () => {
      process.env.GEMINI_PLUGIN_ROOT = '/root/plugin';
      process.env.GEMINI_PROJECT_DIR = '/root/project';
      vi.resetModules();
